...
class Fragtrend(private val mainDialogeven: Fragporbazdid) : BottomSheetDialogFragment(),Itemevent {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val data = arrayListOf<Itempost>(
            Itempost(
                ...
                "محسن چاوشی پس از دریافت فوق دیپلم حسابداری و اتمام دوره سربازی، فعالیت حرفه\u200Cای خود را در زمینهٔ موسیقی در سال ۱۳۸۲ با آلبوم نفرین آغاز کرد و پس از اخذ مجوز در سال ۱۳۸۷ آلبوم یه شاخه نیلوفر را منتشر کرد. از وی تاکنون بیش از ۲۰۰ قطعه موسیقی شنیده شده\u200Cاست، که شامل ۱۱ آلبوم و نیز چندین تک\u200Cآهنگ است.[۱۰]\n" +
                        ...
                        "\n" +
                        "چاوشی خواننده ترانه\u200Cهای سریال شبکه خانگی شهرزاد ساختهٔ حسن فتحی می\u200Cباشد که این ترانه\u200Cها خصوصاً تک\u200Cآهنگ کجایی نقش بسزایی در محبوبیت او داشت.[۱۱][۱۲]",
                true,
                "260 هزار نفر"
            ),
            ...
            Itempost(
                ...
                "علی زند وکیلی فعالیت هنری خود را از هفت سالگی با نواختن تنبک و آواز آغاز کرد و در سال ۱۳۷۷ به هنرستان موسیقی شیراز وارد شد و نواختن سنتور و پیانو را آموخت. سال ۱۳۸۱ به هنرستان موسیقی تهران وارد و از همان هنرستان فارغ\u200Cالتحصیل شد. وی به همراه برادر خود، محمد زند وکیلی و میلاد ذبیحی گروهی را تحت عنوان زند بند تأسیس کرد. علاوه بر آن سابقه همکاری با گروه\u200Cهای دنگ شو، خموش، طلوع، نغمه کیمیا، شروند و گلبانگ را دارد و کنسرت\u200Cهایی نیز به همراه این گروه\u200Cها برگزار کرده\u200Cاست.\n" +
                        "از جمله کارهای شاخص وی می\u200Cتوان به تیتراژ مجموعه\u200Cهای دزد و پلیس، پژمان (آخر قصه)، شاهگوش (زهره)، پادری (پادری) زیر پای مادر (آخرین رؤیا)و سریال خانگی اقا زاده (آخرین آواز) اشاره کرد. او در زمستان ۱۳۹۲ آلبومی را تحت عنوان عبور از مه در سبک سنتی با اشعاری از حافظ، زهرا پناهی، حسین منزوی و وحشی بافقی در ۱۴ قطعه منتشر کرد.[نیازمند منبع] علی زندوکیلی در بهمن ۱۳۹۳ در اختتامیه جشنواره فیلم فجر به همراه مهران مدیری آهنگ\u200Cهای ناردونه و رفتی را به صورت زنده اجرا کرد که بسیار از این اجرای او استقبال شد.[۴] علی زندوکیلی در سی\u200Cامین جشنواره موسیقی فجر در شیراز در ۲۴ بهمن ماه ۱۳۹۳ به اجرای برنامه پرداخت.",
                true,
                "100 نفر"
            ),
            Itempost(
        ...
        binding.rcycleTrend.adapter = myadapter



        val fragporbazdid=Fragporbazdid()
        val fm: FragmentTransaction = parentFragmentManager.beginTransaction()
//        binding.btnBazgashtbePorbazdid.setOnClickListener {
//
//            if (!fragporbazdid.isAdded){
//                binding.btnBazgashtbePorbazdid.isVisible=false
//                binding.rcycleTrend.isVisible=false
//                binding.trendiano
//                fm.apply {
//
//                        remove(fraginja)
//                            .add(R.id.trendiano,fragporbazdid,Fragporbazdid::class.java.simpleName)
//                        .addToBackStack(null)
//                        .commit()
//                }
//            }else{
//                Toast.makeText(binding.root.context, "سلام", Toast.LENGTH_SHORT).show()
//            }
//
//        }
